...
const (
	...
	clientPkgPath  = "git.inke.cn/inkelogic/daenerys/rpc/client"
	serverPkgPath  = "git.inke.cn/inkelogic/daenerys/rpc/server"
	proxyPkgPath   = "git.inke.cn/inkelogic/daenerys/proxy"
)
